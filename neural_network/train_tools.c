...
/*char get_random_matrix(double* matrix)
{
    ...
    sprintf(f, "train_data/min/%c%s", file[1], file);
...
char get_random_matrix(double* matrix)
{
    ...
    char letter = (char)random(0, 51);

    if(letter >= 0 && letter <= 25)
    {
        letter = letter + 65;
        sprintf(path, "train_data/maj/%c/%c%i.txt", letter, letter, (int)random(0, 3));
    }
    else
    {
        letter += 97 - 26;
        sprintf(path, "train_data/min/%c/%c%i.txt", letter, letter, (int)random(0, 3));
    }
